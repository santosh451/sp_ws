...
static const _ActuatorCmds_type_support_symbol_names_t _ActuatorCmds_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, communication, msg, ActuatorCmds)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, communication, msg, ActuatorCmds)),
  }
};
...
{
  return &::communication::msg::rosidl_typesupport_cpp::ActuatorCmds_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, communication, msg, ActuatorCmds)() {
  return get_message_type_support_handle<communication::msg::ActuatorCmds>();
}
