...
static rosidl_typesupport_introspection_c__MessageMember communication__msg__MotionCommands__rosidl_typesupport_introspection_c__MotionCommands_message_member_array[4] = {
  {
    "header",  // name
