...
#include "communication/srv/detail/gait_switch__rosidl_typesupport_fastrtps_c.h"
...
using _GaitSwitch_Request__ros_msg_type = communication__srv__GaitSwitch_Request;
...
size_t get_serialized_size_communication__srv__GaitSwitch_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GaitSwitch_Request__ros_msg_type * ros_message = static_cast<const _GaitSwitch_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GaitSwitch_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_communication__srv__GaitSwitch_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_communication
size_t max_serialized_size_communication__srv__GaitSwitch_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = communication__srv__GaitSwitch_Request;
    is_plain =
      (
...
static size_t _GaitSwitch_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_communication__srv__GaitSwitch_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, communication, srv, GaitSwitch_Request)() {
...
using _GaitSwitch_Response__ros_msg_type = communication__srv__GaitSwitch_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_communication
size_t get_serialized_size_communication__srv__GaitSwitch_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GaitSwitch_Response__ros_msg_type * ros_message = static_cast<const _GaitSwitch_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_communication__srv__GaitSwitch_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_communication
size_t max_serialized_size_communication__srv__GaitSwitch_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = communication__srv__GaitSwitch_Response;
    is_plain =
      (
...
static size_t _GaitSwitch_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_communication__srv__GaitSwitch_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, communication, srv, GaitSwitch_Response)() {
...
// already included above
// #include "communication/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "communication/srv/gait_switch.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, communication, srv, GaitSwitch)() {
