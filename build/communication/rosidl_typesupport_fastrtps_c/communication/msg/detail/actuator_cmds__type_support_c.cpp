...
#include "communication/msg/detail/actuator_cmds__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // kd, kp, pos, torque, vel
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // kd, kp, pos, torque, vel
#include "rosidl_runtime_c/string.h"  // actuators_name
#include "rosidl_runtime_c/string_functions.h"  // actuators_name
...
using _ActuatorCmds__ros_msg_type = communication__msg__ActuatorCmds;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: actuators_name
  {
    size_t size = ros_message->actuators_name.size;
    auto array_ptr = ros_message->actuators_name.data;
    if (size > 30) {
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: actuators_name
  {
    ...
    if (ros_message->actuators_name.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->actuators_name);
    }
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->actuators_name, size)) {
      fprintf(stderr, "failed to create array for field 'actuators_name'");
      return false;
    }
    auto array_ptr = ros_message->actuators_name.data;
    for (size_t i = 0; i < size; ++i) {
      ...
      bool succeeded = rosidl_runtime_c__String__assign(
        ...
        tmp.c_str());
      if (!succeeded) {
        fprintf(stderr, "failed to assign string into field 'actuators_name'\n");
        return false;
      }
    }
  }
  ...
  // Field name: torque
  {
    ...
    if (ros_message->torque.data) {
      rosidl_runtime_c__float__Sequence__fini(&ros_message->torque);
    }
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->torque, size)) {
...
size_t get_serialized_size_communication__msg__ActuatorCmds(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ActuatorCmds__ros_msg_type * ros_message = static_cast<const _ActuatorCmds__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ActuatorCmds__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_communication__msg__ActuatorCmds(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_communication
size_t max_serialized_size_communication__msg__ActuatorCmds(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = communication__msg__ActuatorCmds;
    is_plain =
      (
...
static size_t _ActuatorCmds__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_communication__msg__ActuatorCmds(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, communication, msg, ActuatorCmds)() {
