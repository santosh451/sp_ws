...
enum
{
  communication__msg__ActuatorCmds__actuators_name__MAX_SIZE = 30
};
// kp
enum
{
  communication__msg__ActuatorCmds__kp__MAX_SIZE = 30
};
// pos
enum
{
  communication__msg__ActuatorCmds__pos__MAX_SIZE = 30
};
// kd
enum
{
  communication__msg__ActuatorCmds__kd__MAX_SIZE = 30
};
// vel
enum
{
  communication__msg__ActuatorCmds__vel__MAX_SIZE = 30
};
// torque
enum
{
  communication__msg__ActuatorCmds__torque__MAX_SIZE = 30
};
